        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-5">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-brand-300">
    ...
    <div className="p-6 md:p-8 max-w-[1200px] mx-auto">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 mb-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0 mb-6">
          <button
            onClick={() => openSetup()}
            className="px-4 py-2 bg-brand-500 text-white rounded-lg hover:bg-brand-600 transition-colors font-medium flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-4 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-300 w-64" />
            ...
            <select
              ...
              className="px-3 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-300">
